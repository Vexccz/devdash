  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, sans-serif; max-width: 560px; margin: 0 auto;">
        ...
        <p style="color: #475569; line-height: 1.6;">Your ${APP_NAME()} account is ready.</p>
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, sans-serif; max-width: 560px; margin: 0 auto;">
        ...
        <p style="color: #475569;">Link expires in 30 minutes.</p>
...
export async function sendPaymentSuccessEmail(user) {
  return sendEmail({
    ...
    html: `<div style="font-family: -apple-system, sans-serif;"><h1>Welcome to Pro</h1><p>Your subscription is active.</p></div>`,
  });
}
